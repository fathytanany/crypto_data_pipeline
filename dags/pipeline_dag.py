...
from scripts.operations import fetch_data, store_data_to_s3, transform_data, store_transformed_to_s3
...
with DAG(
    ...
    fetch_data_task = PythonOperator(
        ...
        op_kwargs={"ts": "{{ ti.xcom_pull(task_ids='get_timestamp') }}",
                   ...
                   "API_params":{"vs_currency": "usd", "order":"market_cap_desc", "price_change_percentage": "24h"}},
    ...
    store_transformed_data_task = PythonOperator(
    ...
    # modeling_task = RedshiftDataOperator(
    #     task_id="model_crypto_data",
    #     sql=open("utils/redshift_sql/modeling.sql").read(),
    #     database=os.getenv("DB_NAME"),
    #     workgroup_name="default-workgroup",
    #     region=os.getenv("AWS_REGION"),
    #     aws_conn_id='redshift_1',
    ...
    get_ts >> fetch_data_task >> store_data_task >> transform_data_task >> store_transformed_data_task  >> copy_to_redshift_task 
    create_table_task >> copy_to_redshift_task
